...
def test_ustar_cp(
    ...
    - test_engine: A fixture that initializes the MATLAB engine session and adds the necessary
    ...
    assert exitcode == expected_values[0], (
    ...
    assert comparison, (
        "Expected test and reference output folders have same contents, but comparison test fails"
    )
